...
`ioc-cfn-cognitive-agents` project.
...
The `ioc-cfn-cognitive-agents` maintainers take all security issues in the project
seriously. Thank you for improving the security of `ioc-cfn-cognitive-agents`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`ioc-cfn-cognitive-agents` leverages GitHub's private vulnerability reporting.
